...
latex_documents = [
    (master_doc, 'EnOSDocumentationCenter.tex', 'EnOS Documentation Center Documentation',
     'Zhijun Gao', 'manual'),
]
...
man_pages = [
    (master_doc, 'enosdocumentationcenter', 'EnOS Documentation Center Documentation',
     [author], 1)
]
